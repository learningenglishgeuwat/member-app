    ...
    <div className="pronunciation-layout pronunciation-theme pronunciation-theme--stressing sh-page">
      ...
      <main className="sh-shell">
        <header className="sh-header">
          <h1 className="sh-title font-display">Stressing</h1>
          <p className="sh-subtitle font-sans">Pilih jalur latihan sebelum masuk materi.</p>
        </header>
        ...
        <section className="sh-grid" aria-label="Stressing categories">
          <Link href="/skill/pronunciation/stressing/word-stress" className="sh-card sh-card-word">
            <div className="sh-card-top">
              <h2 className="sh-card-title font-display">Word Stress</h2>
              <p className="sh-card-desc font-sans">Tekanan suku kata di dalam kata.</p>
            </div>
            <ul className="sh-card-bullets font-sans">
              <li>IPA stress marks</li>
              <li>Quick rules</li>
              <li>Noun–verb contrast</li>
              <li>Practice bank</li>
            </ul>
            <span className="sh-card-cta font-sans font-semibold tracking-wider">Mulai</span>
          </Link>
          ...
          >
            <div className="sh-card-top">
              <h2 className="sh-card-title font-display">Sentence Stress</h2>
              <p className="sh-card-desc font-sans">Tekanan kata di dalam kalimat.</p>
            </div>
            <ul className="sh-card-bullets font-sans">
              <li>Meaning focus</li>
