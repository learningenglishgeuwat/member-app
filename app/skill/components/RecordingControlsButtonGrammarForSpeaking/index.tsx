...
const RecordingControlsButtonGrammarForSpeaking: React.FC<RecordingControlsButtonProps> = ({
  ...
  const [showControlDeck, setShowControlDeck] = useState(defaultOpen);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#0a0f1c] border border-cyber-cyan/40 rounded-2xl p-4 sm:p-6 max-w-[90vw] sm:max-w-md max-h-[80vh] overflow-y-auto w-full shadow-[0_0_50px_rgba(190,41,236,0.3)] mx-4 sm:mx-auto text-sm sm:text-[15px] leading-6 sm:leading-7">
            ...
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold text-white">Instruksi Perekaman Grammar Speaking</h3>
            </div>
...
export default RecordingControlsButtonGrammarForSpeaking;
