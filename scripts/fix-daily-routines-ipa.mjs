...
const DAILY_IPA = new Map([
  ...
  ['She gets up early.', '/ʃi ɡɛts ʌp ˈɚli/'],
  ...
  ['I go to work at eight.', '/aɪ ɡoʊ tə wɚk æt eɪt/'],
  ['She takes the bus to campus.', '/ʃi teɪks ðə bʌs tə ˈkæmpəs/'],
  ['He drives to work every day.', '/hi draɪvz tə wɚk ˈɛvri deɪ/'],
  ['I start work at nine.', '/aɪ stɑrt wɚk æt naɪn/'],
  ...
  ['He does homework after school.', '/hi dʌz ˈhoʊmˌwɚk ˈæftɚ skul/'],
  ...
  ['I relax after work.', '/aɪ rɪˈlæks ˈæftɚ wɚk/'],
  ...
  ['She feeds the dog before work.', '/ʃi fidz ðə dɔɡ bɪˈfɔr wɚk/'],
  ['We shop for groceries on Friday.', '/wi ʃɑp fər ˈɡroʊsəriz ɑn ˈfraɪdeɪ/'],
  ['I return home at five.', '/aɪ rɪˈtɚn hoʊm æt faɪv/'],
  ...
  ['She wakes up early every day.', '/ʃi weɪks ʌp ˈɚli ˈɛvri deɪ/'],
  ...
  ['I leave home at seven-thirty.', '/aɪ liv hoʊm æt ˌsɛvənˈθɚti/'],
  ['He arrives at work at eight.', '/hi əˈraɪvz æt wɚk æt eɪt/'],
  ...
  ['We finish work at five.', '/wi ˈfɪnɪʃ wɚk æt faɪv/'],
  ...
  ['I pack lunch for work.', '/aɪ pæk lʌntʃ fər wɚk/'],
  ...
  ['I turn off the lights before sleeping.', '/aɪ tɚn ɔf ðə laɪts bɪˈfɔr ˈslipɪŋ/'],
  ...
  ['I make coffee at six-thirty.', '/aɪ meɪk ˈkɔfi æt ˌsɪksˈθɚti/'],
  ...
  ['I refill my water bottle at work.', '/aɪ ˌriˈfɪl maɪ ˈwɔtɚ ˈbɑtəl æt wɚk/'],
  ['My mother takes vitamins every day.', '/maɪ ˈmʌðɚ teɪks ˈvaɪtəmɪnz ˈɛvri deɪ/'],
  ['I check homework after dinner.', '/aɪ tʃɛk ˈhoʊmˌwɚk ˈæftɚ ˈdɪnɚ/'],
  ...
  ['He picks up groceries after work.', '/hi pɪks ʌp ˈɡroʊsəriz ˈæftɚ wɚk/'],
