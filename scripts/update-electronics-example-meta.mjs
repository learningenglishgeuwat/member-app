...
const ELECTRONICS_ROWS = [
  { en: 'I like learning about electronics.', id: 'Saya suka belajar tentang elektronik.', ipa: '/aɪ laɪk ˈlɚnɪŋ əˈbaʊt ɪˌlɛkˈtrɑnɪks/' },
  ...
  { en: 'This machine works fast.', id: 'Mesin ini bekerja cepat.', ipa: '/ðɪs məˈʃin wɚks fæst/' },
  ...
  { en: 'She uses a smartphone for work.', id: 'Dia memakai smartphone untuk kerja.', ipa: '/ʃi ˈjuzɪz ə ˈsmɑrtˌfoʊn fɔr wɚk/' },
  ...
  { en: 'Please use the scanner first.', id: 'Tolong pakai scanner dulu.', ipa: '/pliz juz ðə ˈskænər fɚst/' },
  { en: 'This camera takes clear photos.', id: 'Kamera ini menghasilkan foto yang jelas.', ipa: '/ðɪs ˈkæmərə teɪks klɪr ˈfoʊtoʊz/' },
  { en: 'Turn on your webcam during the meeting.', id: 'Nyalakan webcam saat rapat.', ipa: '/tɚn ɑn jʊr ˈwɛbˌkæm ˈdʊrɪŋ ðə ˈmitɪŋ/' },
  ...
  { en: 'Turn the switch off.', id: 'Matikan saklarnya.', ipa: '/tɚn ðə swɪtʃ ɔf/' },
  ...
  { en: 'Turn on Bluetooth first.', id: 'Nyalakan Bluetooth dulu.', ipa: '/tɚn ɑn ˈbluˌtuθ fɚst/' },
  ...
  { en: 'Insert the memory card carefully.', id: 'Masukkan kartu memori dengan hati-hati.', ipa: '/ɪnˈsɚt ðə ˈmɛməri kɑrd ˈkɛrfəli/' },
  ...
  { en: 'Disconnect the cable first.', id: 'Lepaskan kabelnya dulu.', ipa: '/ˌdɪskəˈnɛkt ðə ˈkeɪbəl fɚst/' },
