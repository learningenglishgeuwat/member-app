...
const ORDINAL_ROWS = [
  { en: 'This is my first class.', id: 'Ini kelas pertama saya.', ipa: '/ðɪs ɪz maɪ fɚst klæs/' },
  { en: 'She sits in the second row.', id: 'Dia duduk di baris kedua.', ipa: '/ʃi sɪts ɪn ðə ˈsɛkənd roʊ/' },
  { en: 'He is the third speaker.', id: 'Dia pembicara ketiga.', ipa: '/hi ɪz ðə θɚd ˈspikɚ/' },
  ...
  { en: 'My birthday is on the tenth.', id: 'Ulang tahun saya tanggal sepuluh.', ipa: '/maɪ ˈbɚθdeɪ ɪz ɑn ðə tɛnθ/' },
  ...
  { en: 'Today is the thirteenth.', id: 'Hari ini tanggal tiga belas.', ipa: '/təˈdeɪ ɪz ðə θɚˈtinθ/' },
  ...
  { en: 'My appointment is on the twenty-first.', id: 'Janji saya tanggal dua puluh satu.', ipa: '/maɪ əˈpɔɪntmənt ɪz ɑn ðə ˌtwɛntiˈfɚst/' },
  { en: 'He is the twenty-second member.', id: 'Dia anggota kedua puluh dua.', ipa: '/hi ɪz ðə ˌtwɛntiˈsɛkənd ˈmɛmbɚ/' },
  { en: 'The class starts on the twenty-third.', id: 'Kelas mulai tanggal dua puluh tiga.', ipa: '/ðə klæs stɑrts ɑn ðə ˌtwɛntiˈθɚd/' },
  ...
  { en: 'The thirtieth student is absent.', id: 'Siswa ketiga puluh tidak hadir.', ipa: '/ðə ˈθɚtiəθ ˈstudənt ɪz ˈæbsənt/' },
  { en: 'Some months end on the thirty-first.', id: 'Beberapa bulan berakhir di tanggal tiga puluh satu.', ipa: '/sʌm mʌnθs ɛnd ɑn ðə ˌθɚtiˈfɚst/' },
