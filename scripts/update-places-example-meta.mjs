...
const PLACES_ROWS = [
  ...
  { en: 'My mother works in the garden.', id: 'Ibu saya berkebun di kebun.', ipa: '/maɪ ˈmʌðɚ wɚks ɪn ðə ˈɡɑrdən/' },
  ...
  { en: 'This restaurant serves local food.', id: 'Restoran ini menyajikan makanan lokal.', ipa: '/ðɪs ˈrɛstərənt sɚvz ˈloʊkəl fud/' },
  ...
  { en: 'My office is on the third floor.', id: 'Kantor saya ada di lantai tiga.', ipa: '/maɪ ˈɔfɪs ɪz ɑn ðə θɚd flɔr/' },
  ...
  { en: 'She works at the hospital.', id: 'Dia bekerja di rumah sakit.', ipa: '/ʃi wɚks æt ðə ˈhɑspɪtəl/' },
  ...
  { en: 'The bus terminal is far from here.', id: 'Terminal busnya jauh dari sini.', ipa: '/ðə bʌs ˈtɚmənəl ɪz fɑr frʌm hɪr/' },
  ...
  { en: 'Cross the bridge and turn right.', id: 'Seberangi jembatan lalu belok kanan.', ipa: '/krɔs ðə brɪdʒ ənd tɚn raɪt/' },
  { en: 'The cafe is on the corner.', id: 'Kafenya ada di sudut jalan.', ipa: '/ðə kæˈfeɪ ɪz ɑn ðə ˈkɔrnɚ/' },
  { en: 'Turn left at the intersection.', id: 'Belok kiri di persimpangan.', ipa: '/tɚn lɛft æt ði ˌɪntɚˈsɛkʃən/' },
  { en: 'Her office is downtown.', id: 'Kantornya ada di pusat kota.', ipa: '/hɚ ˈɔfɪs ɪz ˈdaʊnˌtaʊn/' },
  { en: 'They live in the suburb.', id: 'Mereka tinggal di pinggiran kota.', ipa: '/ðeɪ lɪv ɪn ðə ˈsʌbɚb/' },
