...
const CLOTHES_ROWS = [
  ...
  { en: 'He is wearing a blue shirt.', id: 'Dia memakai kemeja biru.', ipa: '/hi ɪz ˈwɛrɪŋ ə blu ʃɚt/' },
  { en: 'I like this white T-shirt.', id: 'Saya suka kaos putih ini.', ipa: '/aɪ laɪk ðɪs waɪt ˈti ʃɚt/' },
  ...
  { en: 'The skirt is too long for me.', id: 'Rok ini terlalu panjang buat saya.', ipa: '/ðə skɚt ɪz tu lɔŋ fɔr mi/' },
  ...
  { en: 'He wears a tie at work.', id: 'Dia pakai dasi saat kerja.', ipa: '/hi wɛrz ə taɪ æt wɚk/' },
  ...
  { en: 'The shirt collar is clean.', id: 'Kerah kemejanya bersih.', ipa: '/ðə ʃɚt ˈkɑlər ɪz klin/' },
  { en: 'What size do you wear?', id: 'Kamu pakai ukuran apa?', ipa: '/wʌt saɪz du ju wɛr/' },
  { en: 'This shirt is too small.', id: 'Kemeja ini terlalu kecil.', ipa: '/ðɪs ʃɚt ɪz tu smɔl/' },
  ...
  { en: 'My shoes are dirty.', id: 'Sepatu saya kotor.', ipa: '/maɪ ʃuz ɑr ˈdɚti/' },
  ...
  { en: 'I wear a white shirt to work.', id: 'Saya pakai kemeja putih ke kantor.', ipa: '/aɪ wɛr ə waɪt ʃɚt tə wɚk/' },
];
