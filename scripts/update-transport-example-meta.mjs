...
const TRANSPORT_ROWS = [
  ...
  { en: 'I go to work by car.', id: 'Saya pergi kerja naik mobil.', ipa: '/aɪ ɡoʊ tə wɚk baɪ kɑr/' },
  ...
  { en: 'We arrived at the airport early.', id: 'Kami tiba di bandara lebih awal.', ipa: '/wi əˈraɪvd æt ði ˈɛrˌpɔrt ˈɚli/' },
  { en: 'Meet me at the station.', id: 'Temui saya di stasiun.', ipa: '/mit mi æt ðə ˈsteɪʃən/' },
  { en: 'The bus terminal is very crowded.', id: 'Terminal busnya sangat ramai.', ipa: '/ðə bʌs ˈtɚmənəl ɪz ˈvɛri ˈkraʊdəd/' },
  ...
  { en: 'Check the bus schedule first.', id: 'Cek jadwal bus dulu.', ipa: '/tʃɛk ðə bʌs ˈskɛdʒuːl fɚst/' },
  ...
  { en: 'You need one transfer downtown.', id: 'Kamu perlu satu kali transit ke pusat kota.', ipa: '/ju nid wʌn trænsˈfɚ ˈdaʊnˌtaʊn/' },
  ...
  { en: 'Turn left at the next street.', id: 'Belok kiri di jalan berikutnya.', ipa: '/tɚn lɛft æt ðə nɛkst strit/' },
  ...
  { en: 'Please come early to the station.', id: 'Tolong datang lebih awal ke stasiun.', ipa: '/pliz kʌm ˈɚli tə ðə ˈsteɪʃən/' },
