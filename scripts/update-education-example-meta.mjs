...
const EDUCATION_ROWS = [
  ...
  { en: 'I want to learn English well.', id: 'Saya ingin belajar bahasa Inggris dengan baik.', ipa: '/aɪ wɑnt tə lɚn ˈɪŋɡlɪʃ wɛl/' },
  ...
  { en: 'I finished my homework early.', id: 'Saya menyelesaikan PR lebih awal.', ipa: '/aɪ ˈfɪnɪʃt maɪ ˈhoʊmˌwɚk ˈɚli/' },
  ...
  { en: 'Her presentation was clear.', id: 'Presentasinya jelas.', ipa: '/hɚ ˌprɛzənˈteɪʃən wəz klɪr/' },
  ...
  { en: 'She got her diploma last year.', id: 'Dia mendapat ijazah tahun lalu.', ipa: '/ʃi ɡɑt hɚ dɪˈploʊmə læst jɪr/' },
  ...
  { en: 'He studies at a university.', id: 'Dia kuliah di universitas.', ipa: '/hi ˈstʌdiz æt ə ˌjunəˈvɚsəti/' },
  { en: 'The campus is very large.', id: 'Kampusnya sangat luas.', ipa: '/ðə ˈkæmpəs ɪz ˈvɛri lɑrdʒ/' },
  { en: 'Her major is biology.', id: 'Jurusannya biologi.', ipa: '/hɚ ˈmeɪdʒər ɪz baɪˈɑlədʒi/' },
  ...
  { en: 'Two students were absent today.', id: 'Dua siswa tidak hadir hari ini.', ipa: '/tu ˈstudənts wɚ ˈæbsənt təˈdeɪ/' },
  ...
  { en: 'Use a dictionary for new words.', id: 'Gunakan kamus untuk kata-kata baru.', ipa: '/juz ə ˈdɪkʃəˌnɛri fɔr nu wɚdz/' },
  { en: 'They are doing research together.', id: 'Mereka sedang melakukan riset bersama.', ipa: '/ðeɪ ɑr ˈduɪŋ rɪˈsɚtʃ təˈɡɛðər/' },
  ...
  { en: 'He is a university graduate.', id: 'Dia lulusan universitas.', ipa: '/hi ɪz ə ˌjunəˈvɚsəti ˈɡrædʒuət/' },
];
