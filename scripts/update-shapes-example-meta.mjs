...
const SHAPES_ROWS = [
  ...
  { en: 'The letter S has a curved line.', id: 'Huruf S punya garis lengkung.', ipa: '/ðə ˈlɛtər ɛs hæz ə kɚvd laɪn/' },
  ...
  { en: 'Draw a big circle.', id: 'Gambar lingkaran besar.', ipa: '/drɔ ə bɪɡ ˈsɚkəl/' },
  { en: 'Cut the paper into a semicircle.', id: 'Potong kertas menjadi setengah lingkaran.', ipa: '/kʌt ðə ˈpeɪpər ˈɪntu ə ˈsɛmiˌsɚkəl/' },
  ...
  { en: 'Draw a ring, not a full circle.', id: 'Gambar lingkaran kosong, bukan lingkaran penuh.', ipa: '/drɔ ə rɪŋ nɑt ə fʊl ˈsɚkəl/' },
