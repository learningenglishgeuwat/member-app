...
const PHYSICAL_APPEARANCE_ROWS = [
  { en: 'Her appearance is neat and simple.', id: 'Penampilannya rapi dan sederhana.', ipa: '/hɚ əˈpɪrəns ɪz nit ænd ˈsɪmpəl/' },
  ...
  { en: 'Her straight hair is very shiny.', id: 'Rambut lurusnya sangat berkilau.', ipa: '/hɚ streɪt hɛr ɪz ˈvɛri ˈʃaɪni/' },
  { en: 'He has curly hair.', id: 'Dia berambut keriting.', ipa: '/hi hæz ˈkɚli hɛr/' },
  ...
  { en: 'Her eyes are bright.', id: 'Matanya cerah.', ipa: '/hɚ aɪz ɑr braɪt/' },
  ...
  { en: 'She has freckles on her cheeks.', id: 'Dia punya bintik-bintik di pipinya.', ipa: '/ʃi hæz ˈfrɛkəlz ɑn hɚ tʃiks/' },
  { en: 'Her dimples are cute.', id: 'Lesung pipinya lucu.', ipa: '/hɚ ˈdɪmpəlz ɑr kjut/' },
  { en: 'What is your height?', id: 'Berapa tinggi badan Anda?', ipa: '/wʌt ɪz jʊr haɪt/' },
  { en: 'Her weight is normal.', id: 'Berat badannya normal.', ipa: '/hɚ weɪt ɪz ˈnɔrməl/' },
  ...
  { en: 'Her cheek is red.', id: 'Pipinya merah.', ipa: '/hɚ tʃik ɪz rɛd/' },
