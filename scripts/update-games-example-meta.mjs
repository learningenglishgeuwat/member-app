...
const GAMES_ROWS = [
  ...
  { en: 'We won the first round.', id: 'Kami menang di ronde pertama.', ipa: '/wi wʌn ðə fɚst raʊnd/' },
  { en: 'It is your turn.', id: 'Sekarang giliranmu.', ipa: '/ɪt ɪz jʊr tɚn/' },
  ...
  { en: 'Our strategy worked well.', id: 'Strategi kami berhasil dengan baik.', ipa: '/aʊər ˈstrætədʒi wɚkt wɛl/' },
  ...
  { en: 'The server is full.', id: 'Server-nya penuh.', ipa: '/ðə ˈsɚvər ɪz fʊl/' },
