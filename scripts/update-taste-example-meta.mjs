...
const TASTE_ROWS = [
  ...
  { en: 'Can I get a mild curry?', id: 'Boleh minta kari yang tidak terlalu pedas?', ipa: '/kæn aɪ ɡɛt ə maɪld ˈkɚi/' },
  ...
  { en: 'The toast tastes burnt.', id: 'Roti panggang ini rasanya gosong.', ipa: '/ðə toʊst teɪsts bɚnt/' },
  ...
  { en: 'Wow, this dessert is yummy.', id: 'Wah, dessert ini enak banget.', ipa: '/waʊ ðɪs dɪˈzɚt ɪz ˈjʌmi/' },
  ...
  { en: 'I liked it from the first bite.', id: 'Saya suka dari gigitan pertama.', ipa: '/aɪ laɪkt ɪt frəm ðə fɚst baɪt/' },
