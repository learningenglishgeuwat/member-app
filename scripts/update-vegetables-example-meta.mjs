...
const VEGETABLE_ROWS = [
  ...
  { en: 'Stir-fry green beans with garlic.', id: 'Tumis buncis dengan bawang putih.', ipa: '/ˈstɚ fraɪ ɡrin binz wɪð ˈɡɑrlɪk/' },
  ...
  { en: 'Turmeric gives yellow color.', id: 'Kunyit memberi warna kuning.', ipa: '/ˈtɚmərɪk ɡɪvz ˈjɛloʊ ˈkʌlər/' },
  ...
  { en: 'Okra is good in curry.', id: 'Okra enak dimasak kari.', ipa: '/ˈoʊkrə ɪz ɡʊd ɪn ˈkɚi/' },
  { en: 'Stir-fry bok choy quickly.', id: 'Tumis pakcoy sebentar saja.', ipa: '/ˈstɚ fraɪ bɑk tʃɔɪ ˈkwɪkli/' },
  ...
  { en: 'I prefer organic vegetables.', id: 'Saya lebih suka sayuran organik.', ipa: '/aɪ prɪˈfɚ ɔrˈɡænɪk ˈvɛdʒtəbəlz/' },
  { en: 'Please chop the carrot.', id: 'Tolong potong wortelnya.', ipa: '/pliz tʃɑp ðə ˈkærət/' },
  { en: 'Boil the potatoes first.', id: 'Rebus kentangnya dulu.', ipa: '/bɔɪl ðə pəˈteɪtoʊz fɚst/' },
  { en: 'I stir-fry vegetables for dinner.', id: 'Saya menumis sayuran untuk makan malam.', ipa: '/aɪ ˈstɚ fraɪ ˈvɛdʒtəbəlz fɔr ˈdɪnər/' },
];
