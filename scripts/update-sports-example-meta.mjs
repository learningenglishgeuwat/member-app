...
const SPORTS_ROWS = [
  ...
  { en: 'We do a short workout before class.', id: 'Kami melakukan latihan fisik singkat sebelum kelas.', ipa: '/wi du ə ʃɔrt ˈwɚkaʊt bɪˈfɔr klæs/' },
  ...
  { en: 'He wants to learn tennis.', id: 'Dia ingin belajar tenis.', ipa: '/hi wɑnts tə lɚn ˈtɛnɪs/' },
  ...
  { en: 'She does yoga before work.', id: 'Dia melakukan yoga sebelum kerja.', ipa: '/ʃi dʌz ˈjoʊɡə bɪˈfɔr wɚk/' },
  { en: 'He is learning martial arts.', id: 'Dia sedang belajar seni bela diri.', ipa: '/hi ɪz ˈlɚnɪŋ ˈmɑrʃəl ɑrts/' },
  ...
  { en: 'He wears jersey number ten.', id: 'Dia memakai jersey nomor sepuluh.', ipa: '/hi wɛrz ˈdʒɚzi ˈnʌmbər tɛn/' },
