...
const FEELINGS_ROWS = [
  ...
  { en: 'I am tired after work.', id: 'Saya lelah setelah kerja.', ipa: '/aɪ æm taɪɚd ˈæftɚ wɚk/' },
  { en: 'The baby is sleepy.', id: 'Bayinya mengantuk.', ipa: '/ðə ˈbeɪbi ɪz ˈslipi/' },
  { en: 'I am hungry.', id: 'Saya lapar.', ipa: '/aɪ æm ˈhʌŋɡri/' },
  { en: 'I am thirsty.', id: 'Saya haus.', ipa: '/aɪ æm ˈθɚsti/' },
  ...
  { en: 'I feel nervous before the test.', id: 'Saya gugup sebelum ujian.', ipa: '/aɪ fil ˈnɚvəs bɪˈfɔr ðə tɛst/' },
  ...
  { en: 'She is worried about her exam.', id: 'Dia khawatir tentang ujiannya.', ipa: '/ʃi ɪz ˈwɚid əˈbaʊt hɚ ɪɡˈzæm/' },
  ...
  { en: 'My arm is hurt.', id: 'Lengan saya sakit.', ipa: '/maɪ ɑrm ɪz hɚt/' },
