...
const DRINKS_ROWS = [
  ...
  { en: 'He prefers sparkling water.', id: 'Dia lebih suka air soda.', ipa: '/hi prɪˈfɚz ˈspɑrklɪŋ ˈwɔtɚ/' },
  ...
  { en: 'She drinks coffee at work.', id: 'Dia minum kopi di kantor.', ipa: '/ʃi drɪŋks ˈkɔfi æt wɚk/' },
  ...
  { en: 'My grandma makes herbal drinks.', id: 'Nenek saya membuat minuman herbal.', ipa: '/maɪ ˈɡrænˌmɑ meɪks ˈɚbəl drɪŋks/' },
  ...
  { en: 'I prefer an americano.', id: 'Saya lebih suka americano.', ipa: '/aɪ prɪˈfɚ ən əˌmɛrɪˈkɑnoʊ/' },
  { en: 'Hot chocolate is perfect in rain.', id: 'Cokelat panas pas saat hujan.', ipa: '/hɑt ˈtʃɔklət ɪz ˈpɚfɪkt ɪn reɪn/' },
  ...
  { en: 'I am thirsty after walking.', id: 'Saya haus setelah berjalan kaki.', ipa: '/aɪ æm ˈθɚsti ˈæftɚ ˈwɔkɪŋ/' },
  ...
  { en: 'Take a small sip first.', id: 'Coba seruput sedikit dulu.', ipa: '/teɪk ə smɔl sɪp fɚst/' },
