...
const SCHOOL_ROWS = [
  ...
  { en: 'I finish my homework at night.', id: 'Saya menyelesaikan PR pada malam hari.', ipa: '/aɪ ˈfɪnɪʃ maɪ ˈhoʊmwɚk æt naɪt/' },
  ...
  { en: 'Her presentation was very good.', id: 'Presentasinya sangat bagus.', ipa: '/hɚ ˌprɛznˈteɪʃən wəz ˈvɛri ɡʊd/' },
  ...
  { en: 'Page ten is in the workbook.', id: 'Halaman sepuluh ada di buku latihan.', ipa: '/peɪdʒ tɛn ɪz ɪn ðə ˈwɚkbʊk/' },
  ...
  { en: 'Please read the first paragraph.', id: 'Tolong baca paragraf pertama.', ipa: '/pliz rid ðə fɚst ˈpærəˌɡræf/' },
  ...
  { en: 'We learn new words each week.', id: 'Kami mempelajari kata-kata baru setiap minggu.', ipa: '/wi lɚn nu wɚdz itʃ wik/' },
];
