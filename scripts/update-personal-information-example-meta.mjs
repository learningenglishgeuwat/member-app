...
const PERSONAL_INFORMATION_ROWS = [
  ...
  { en: 'What is your first name?', id: 'Siapa nama depan Anda?', ipa: '/wʌt ɪz jʊr fɚst neɪm/' },
  { en: 'Her last name is Putri.', id: 'Nama belakangnya Putri.', ipa: '/hɚ læst neɪm ɪz ˈputri/' },
  { en: 'Your surname is missing on this form.', id: 'Nama keluarga Anda belum terisi di formulir ini.', ipa: '/jʊr ˈsɚˌneɪm ɪz ˈmɪsɪŋ ɑn ðɪs fɔrm/' },
  { en: 'My nickname is Nia.', id: 'Nama panggilan saya Nia.', ipa: '/maɪ ˈnɪkˌneɪm ɪz ˈniə/' },
  { en: 'Please confirm your identity.', id: 'Mohon konfirmasi identitas Anda.', ipa: '/pliz kənˈfɚm jʊr aɪˈdɛntəti/' },
  { en: 'Keep your personal data safe.', id: 'Jaga data pribadi Anda tetap aman.', ipa: '/kip jʊr ˈpɚsənəl ˈdeɪtə seɪf/' },
  ...
  { en: 'My birthday is in July.', id: 'Ulang tahun saya bulan Juli.', ipa: '/maɪ ˈbɚθdeɪ ɪz ɪn dʒʊˈlaɪ/' },
  { en: 'Please enter your birth date.', id: 'Silakan masukkan tanggal lahir Anda.', ipa: '/pliz ˈɛntər jʊr bɚθ deɪt/' },
  { en: 'His birth place is Bandung.', id: 'Tempat lahirnya Bandung.', ipa: '/hɪz bɚθ pleɪs ɪz ˈbændʊŋ/' },
  ...
  { en: 'Save my contact first.', id: 'Simpan kontak saya dulu.', ipa: '/seɪv maɪ ˈkɑnˌtækt fɚst/' },
  { en: 'Write an emergency contact here.', id: 'Tulis kontak darurat di sini.', ipa: '/raɪt ən ɪˈmɚdʒənsi ˈkɑnˌtækt hɪr/' },
  ...
  { en: 'She works at a small company.', id: 'Dia bekerja di perusahaan kecil.', ipa: '/ʃi wɚks æt ə smɔl ˈkʌmpəni/' },
  { en: 'I work in the sales department.', id: 'Saya bekerja di departemen penjualan.', ipa: '/aɪ wɚk ɪn ðə seɪlz dɪˈpɑrtmənt/' },
  ...
  { en: 'Please confirm your email address.', id: 'Tolong konfirmasi alamat email Anda.', ipa: '/pliz kənˈfɚm jʊr ˈimeɪl əˈdrɛs/' },
  ...
  { en: 'Check your personal details again.', id: 'Periksa lagi rincian data pribadi Anda.', ipa: '/tʃɛk jʊr ˈpɚsənəl dɪˈteɪlz əˈɡɛn/' },
];
