...
const HOME_ROWS = [
  ...
  { en: 'Turn on the light switch.', id: 'Nyalakan saklar lampunya.', ipa: '/tɚn ɑn ðə laɪt swɪtʃ/' },
  ...
  { en: 'Turn off the stove.', id: 'Matikan kompornya.', ipa: '/tɚn ɔf ðə stoʊv/' },
  ...
  { en: 'Turn on the fan.', id: 'Nyalakan kipasnya.', ipa: '/tɚn ɑn ðə fæn/' },
  { en: 'The air conditioner is cold.', id: 'AC-nya dingin.', ipa: '/ði ɛr kənˈdɪʃənɚ ɪz koʊld/' },
  { en: 'The curtain is green.', id: 'Tirainya berwarna hijau.', ipa: '/ðə ˈkɚtən ɪz ɡrin/' },
  ...
  { en: 'Please turn off the faucet.', id: 'Tolong matikan kerannya.', ipa: '/pliz tɚn ɔf ðə ˈfɔsɪt/' },
  ...
  { en: 'Add detergent to the washing machine.', id: 'Tambahkan deterjen ke mesin cuci.', ipa: '/æd dɪˈtɚdʒənt tə ðə ˈwɑʃɪŋ məˌʃin/' },
