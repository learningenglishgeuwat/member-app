...
const SHOPPING_ROWS = [
  ...
  { en: 'This shirt fits me well.', id: 'Kemeja ini pas di saya.', ipa: '/ðɪs ʃɚt fɪts mi wɛl/' },
  ...
  { en: 'I want to return this product.', id: 'Saya ingin mengembalikan produk ini.', ipa: '/aɪ wɑnt tə rɪˈtɚn ðɪs ˈprɑdəkt/' },
