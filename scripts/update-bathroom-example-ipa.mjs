...
const BATHROOM_IPA_ROWS = [
  ...
  { en: 'Turn off the faucet.', ipa: '/tɚn ɔf ðə ˈfɔsət/' },
  ...
  { en: 'She prefers body wash.', ipa: '/ʃi prɪˈfɚz ˈbɑdi wɑʃ/' },
  ...
  { en: 'I prefer hot water at night.', ipa: '/aɪ prɪˈfɚ hɑt ˈwɔtər æt naɪt/' },
