...
const TIME_DATE_ROWS = [
  ...
  { en: 'I sleep early at night.', id: 'Saya tidur lebih awal pada malam hari.', ipa: '/aɪ slip ˈɚli ət naɪt/' },
  ...
  { en: 'I work on weekdays.', id: 'Saya kerja di hari kerja.', ipa: '/aɪ wɚk ɑn ˈwikˌdeɪz/' },
  ...
  { en: 'She arrived early.', id: 'Dia datang lebih awal.', ipa: '/ʃi əˈraɪvd ˈɚli/' },
  ...
  { en: 'This is my first class today.', id: 'Ini kelas pertama saya hari ini.', ipa: '/ðɪs ɪz maɪ fɚst klæs təˈdeɪ/' },
  ...
  { en: 'My appointment is on Thursday.', id: 'Janji saya hari Kamis.', ipa: '/maɪ əˈpɔɪntmənt ɪz ɑn ˈθɚzdeɪ/' },
  ...
  { en: 'My birthday is in January.', id: 'Ulang tahun saya di bulan Januari.', ipa: '/maɪ ˈbɚθdeɪ ɪz ɪn ˈdʒænjəˌwɛri/' },
  ...
  { en: 'Her birthday is next week.', id: 'Ulang tahunnya minggu depan.', ipa: '/hɚ ˈbɚθdeɪ ɪz nɛkst wik/' },
  ...
  { en: 'Lunchtime is at twelve-thirty.', id: 'Waktu makan siang itu jam dua belas lewat tiga puluh.', ipa: '/ˈlʌntʃˌtaɪm ɪz æt twɛlv ˈθɚti/' },
  { en: 'My bedtime is ten o clock.', id: 'Waktu tidur saya jam sepuluh tepat.', ipa: '/maɪ ˈbɛdˌtaɪm ɪz tɛn ə klɑk/' },
  { en: 'My wake-up time is five-thirty.', id: 'Saya bangun jam lima lewat tiga puluh.', ipa: '/maɪ weɪk ʌp taɪm ɪz faɪv ˈθɚti/' },
  ...
  { en: 'She calls her mother twice a day.', id: 'Dia menelepon ibunya dua kali sehari.', ipa: '/ʃi kɔlz hɚ ˈmʌðɚ twaɪs ə deɪ/' },
  ...
  { en: 'Finish your homework before dinner.', id: 'Selesaikan PR-mu sebelum makan malam.', ipa: '/ˈfɪnɪʃ jʊr ˈhoʊmˌwɚk bɪˈfɔr ˈdɪnɚ/' },
  ...
  { en: 'I work from nine to five.', id: 'Saya kerja dari jam sembilan sampai jam lima.', ipa: '/aɪ wɚk frʌm naɪn tə faɪv/' },
