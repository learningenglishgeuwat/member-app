...
const WEATHER_ROWS = [
  ...
  { en: 'I heard thunder at midnight.', id: 'Saya dengar guntur tengah malam.', ipa: '/aɪ hɚd ˈθʌndər æt mɪdˈnaɪt/' },
  ...
  { en: 'The hurricane warning is serious.', id: 'Peringatan badai topan ini serius.', ipa: '/ðə ˈhɚɪˌkeɪn ˈwɔrnɪŋ ɪz ˈsɪriəs/' },
  ...
  { en: 'It is thirty degrees today.', id: 'Hari ini suhunya tiga puluh derajat.', ipa: '/ɪt ɪz ˈθɚti dɪˈɡriz təˈdeɪ/' },
