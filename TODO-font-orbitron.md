...
- [x] Pastikan font Orbitron sudah tersedia via `next/font/google` (sudah ada di `app/layout.tsx` sebagai `--font-display`).
...
- [x] Tambahkan CSS guard: seluruh elemen `[data-ipa]` (atau `.font-ipa`) harus tetap memakai `--font-ipa`.
